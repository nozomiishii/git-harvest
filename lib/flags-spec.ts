...
type BooleanFlag = {
  field: 'claudeWorktreeDetached' | 'claudeWorktreeUntouched' | 'worktreeDetached' | 'worktreeUntouched';
  group: string;
  help: string;
  kind: 'boolean';
  token: string;
...
const HELP_GROUPS: { header: string; key: string }[] = [
  { header: 'Worktree threshold (normal path), deletes the stage and everything safer:', key: 'worktree' },
...
export const FLAG_SPECS: FlagSpec[] = [
  { field: 'worktree', group: 'worktree', help: 'Delete from files-changed (everything, uncommitted included)', kind: 'threshold', stage: 'files-changed', token: '--worktree-files-changed' },
  { field: 'worktree', group: 'worktree', help: 'Delete from committed (committed and merged)', kind: 'threshold', stage: 'committed', token: '--worktree-committed' },
  { field: 'claudeWorktree', group: 'claudeWorktree', help: 'Delete from files-changed (everything)', kind: 'threshold', stage: 'files-changed', token: '--claude-worktree-files-changed' },
  { field: 'claudeWorktree', group: 'claudeWorktree', help: 'Delete from committed', kind: 'threshold', stage: 'committed', token: '--claude-worktree-committed' },
  { field: 'branch', group: 'branch', help: 'Delete from committed (everything)', kind: 'threshold', stage: 'committed', token: '--branch-committed' },
  { field: 'worktreeDetached', group: 'offLadder', help: 'Delete detached normal-path worktrees', kind: 'boolean', token: '--worktree-detached', warning: "WARNING: a detached worktree's commits are unreachable;\nremoval can lose them permanently (no reflog recovery)." },
  { field: 'claudeWorktreeDetached', group: 'offLadder', help: 'Delete detached .claude/worktrees/ worktrees (same warning)', kind: 'boolean', token: '--claude-worktree-detached' },
  { field: 'worktreeUntouched', group: 'offLadder', help: 'Delete untouched normal-path worktrees', kind: 'boolean', token: '--worktree-untouched' },
  { field: 'claudeWorktreeUntouched', group: 'offLadder', help: 'Delete untouched .claude/worktrees/ worktrees', kind: 'boolean', token: '--claude-worktree-untouched' },
];
